...
if __name__ == '__main__':
    ...
    parser.add_argument('-MAZE_L', type=int, default=20)
    parser.add_argument('-MAZE_W', type=int, default=20)
    parser.add_argument('-MAZE_H', type=int, default=20)
    args = parser.parse_args()

    os.environ['CUDA_DEVICE_ORDER'] = 'PCI_BUS_ID'
    os.environ['CUDA_VISIBLE_DEVICES'] = args.gpu

    env = Maze(args.MAZE_L, args.MAZE_W, args.MAZE_H)
    ...
    agent = agent_(gamma=args.gamma,
                   epsilon=args.eps,
                   lr=args.lr,
                   input_dims=env.space_cnn.shape,
